...
namespace ExampleFilters
{
                        ...
                        , IAMBufferNegotiation
    {
        ...
        public override int SetMediaType(DirectShow.AMMediaType mt)
        {
            if (mt == null)
            {
                return E_POINTER;
        ...
        public override int CheckMediaType(DirectShow.AMMediaType pmt)
        {
        ...
        public int SetFormat(DirectShow.AMMediaType pmt)
        {
            ...
            HRESULT hr;
            DirectShow.AMMediaType _newType = new DirectShow.AMMediaType(pmt);
            DirectShow.AMMediaType _oldType = new DirectShow.AMMediaType(m_mt);
        ...
        public int GetFormat(out DirectShow.AMMediaType pmt)
        {
            pmt = new DirectShow.AMMediaType(m_mt);
            return NOERROR;
        }
        ...
        {
            DirectShow.AMMediaType pmt;
            DirectShow.VideoStreamConfigCaps _caps;
        ...
        public int GetMaxStreamOffset(out long prtMaxOffset)
        {
            ...
            if (m_rtStreamOffsetMax == -1)
            {
                ...
                if (m_rtStreamOffsetMax < m_rtStreamOffset)
                {
                    m_rtStreamOffsetMax = m_rtStreamOffset;
                }
            }
        ...
        public int Get(Guid guidPropSet, int dwPropID, IntPtr pInstanceData, int cbInstanceData, IntPtr pPropData, int cbPropData, out int pcbReturned)
        {
            ...
            Marshal.StructureToPtr(DirectShow.PinCategory.Capture, pPropData, false);
            return NOERROR;
        }

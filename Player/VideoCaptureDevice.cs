    ...
    public class VideoCaptureDevice
    {
        ...
        public void DisplayPropertyPage( IntPtr parentWindow )
        {
            ...
            lock ( sync )
            {
                ...
                {
                    Debug.WriteLine("Failed creating device object for moniker 741");
                    throw new ApplicationException( "Failed creating device object for moniker. 742" );
                }
        ...
        public void DisplayCrossbarPropertyPage( IntPtr parentWindow )
        {
            lock ( sync )
            {
                ...
                {
                    Debug.WriteLine("The video source must be running in order to display crossbar property page.");
                ...
                {
                    Debug.WriteLine("Crossbar configuration is not supported by currently running video source.");
        ...
        public bool SetCameraProperty( CameraControlProperty property, int value, CameraControlFlags controlFlags )
        {
            ...
            lock ( sync )
            {
                ...
                {
                    Debug.WriteLine("Failed creating device object for moniker. 894");
                    throw new ApplicationException( "Failed creating device object for moniker. 895" );
                }
        ...
        public bool GetCameraProperty( CameraControlProperty property, out int value, out CameraControlFlags controlFlags )
        {
            ...
            lock ( sync )
            {
                ...
                {
                    Debug.WriteLine("Failed creating device object for moniker. 949");
                    throw new ApplicationException( "Failed creating device object for moniker. 950" );
                }
        ...
        public bool GetCameraPropertyRange( CameraControlProperty property, out int minValue, out int maxValue, out int stepSize, out int defaultValue, out CameraControlFlags controlFlags )
        {
            ...
            lock ( sync )
            {
                ...
                {
                    Debug.WriteLine("Failed creating device object for moniker. 1007");
                    throw new ApplicationException( "Failed creating device object for moniker. 1008" );
                }
        ...
        private void WorkerThread( bool runGraph )
        {
            ...
            try
            {
                ...
                if (type == null)
                {
                    Debug.WriteLine("Failed creating capture graph builder");
                ...
                if (type == null)
                {
                    Debug.WriteLine("Failed creating filter graph 1082");
                ...
                {
                    Debug.WriteLine("Failed creating device object for moniker. 1096");
                    throw new ApplicationException("Failed creating device object for moniker 1097");
                }
                ...
                if (type == null)
                {
                    Debug.WriteLine("Failed creating sample grabber");
